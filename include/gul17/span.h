...
class tuple_size<gul17::span<ElementType, Extent>>
    : public integral_constant<size_t, Extent> {};

template <typename ElementType>
class tuple_size<gul17::span<ElementType, gul17::dynamic_extent>>; // not defined

template <size_t I, typename ElementType, size_t Extent>
class tuple_element<I, gul17::span<ElementType, Extent>> {
public:
