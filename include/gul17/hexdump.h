...
#ifndef GUL17_HEXDUMP_H_
#define GUL17_HEXDUMP_H_
...
/**
 * \addtogroup hexdump_h gul17/hexdump.h
 ...
 * representation of the printable characters is dumped. An std::optional prompt can be added
 ...
 * \param prompt (std::optional) String that prefixes the dump text
 *
