 ...
 * \brief  Provides a gul17::expected that implements the main functionality of C++23's
 *         std::expected.
 *
 * \copyright
 * Written in 2017 by Sy Brand (tartanllama@gmail.com, @TartanLlama)
 * Modifications for GUL17 in 2023 by Lars Fröhlich
 *
...
#ifndef GUL17_EXPECTED_H_
#define GUL17_EXPECTED_H_
...
/**
 * \addtogroup expected_h gul17/expected.h
 ...
 *
 * \note
 * The GUL17 version is an adaptation of Sy Brand's implementation (see \ref expected.h)
...
#define GUL17_EXPECTED_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T)                         \
  gul17::detail::is_trivially_copy_constructible<T>
#define GUL17_EXPECTED_IS_TRIVIALLY_COPY_ASSIGNABLE(T)                            \
  std::is_trivially_copy_assignable<T>
#define GUL17_EXPECTED_IS_TRIVIALLY_DESTRUCTIBLE(T)                               \
...
#ifdef GUL17_EXPECTED_EXCEPTIONS_ENABLED
...
#ifndef GUL17_TRAITS_MUTEX
#define GUL17_TRAITS_MUTEX
// C++17-style aliases for brevity
...
// Trait for checking if a type is a gul17::expected
...
template <class T, class E,
          bool = is_void_or<T, GUL17_EXPECTED_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T)>::
              value &&GUL17_EXPECTED_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(E)::value>
...
template <class T, class E,
          bool = is_void_or<
              T, conjunction<GUL17_EXPECTED_IS_TRIVIALLY_COPY_ASSIGNABLE(T),
                             GUL17_EXPECTED_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T),
                             GUL17_EXPECTED_IS_TRIVIALLY_DESTRUCTIBLE(T)>>::value
              &&GUL17_EXPECTED_IS_TRIVIALLY_COPY_ASSIGNABLE(E)::value
                  &&GUL17_EXPECTED_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(E)::value
                      &&GUL17_EXPECTED_IS_TRIVIALLY_DESTRUCTIBLE(E)::value>
