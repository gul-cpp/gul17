 ...
 *
 * Most of the library is distributed under the
 * \ref license_boost_1_0 "Boost Software License, Version 1.0", but exceptions apply for
 * individual files. Please refer to the
 * [README file](https://github.com/gul-cpp/gul17/blob/main/README.md) in the library
